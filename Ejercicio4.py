...
x_7 = np.dot(np.linalg.matrix_power(matrix_Trancicion, 7), x_0)
print(
    "Probabilidad de que la maquina funcione correctamente durante 7 días ===> "+str(x_7[0]))

x_3 = np.dot(np.linalg.matrix_power(matrix_Trancicion, 3), x_0)
print(
    "Probabilidad de que la maquina entre en mantencion 3 días ===> "+str(x_3[1]))

x_5 = np.dot(np.linalg.matrix_power(matrix_Trancicion, 5), x_0)
print(
    "Probabilidad de que entre en mantencion en 5 días ===> "+str(x_3[2]))

# x_k = np.dot(np.linalg.matrix_power(matrix_Trancicion, 3), x_0)
# print(x_k)
